...
hi Underlined ctermbg=0 ctermfg=0 cterm=underline
hi StatusLine ctermbg=0 ctermfg=1
hi StatusLineNC ctermbg=0 ctermfg=0
hi TabLine ctermbg=NONE ctermfg=8
hi TabLineFill ctermbg=NONE ctermfg=8
hi TabLineSel ctermbg=4 ctermfg=0
hi TermCursorNC ctermbg=1 ctermfg=1
...
hi CursorLineNr ctermbg=1 ctermfg=0
...
hi signColumn ctermbg=1 ctermfg=4
...
hi Cursor ctermbg=1 ctermfg=0
hi Structure ctermbg=1 ctermfg=5
hi CursorColumn ctermbg=1 ctermfg=1
