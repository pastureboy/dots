...
if os.path.isfile(colors_absolute):
    ...
    # Type: QtColor
    c.colors.downloads.error.bg = colors['special']['background']

    # Foreground color for downloads with errors.
    # Type: QtColor
    c.colors.downloads.error.fg = colors['colors']['color1']

    # Color gradient stop for download backgrounds.
    # Type: QtColor
    c.colors.downloads.stop.bg = colors['colors']['color1']
    ...
    # Type: QssColor
    c.colors.messages.error.fg = colors['colors']['color1']
    ...
    # # Type: String
    c.colors.prompts.border = '0px solid ' + colors['special']['background']
